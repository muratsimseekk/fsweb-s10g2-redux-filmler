...
const AppHeader = (props) => {
  ...
  // toggle Fav action dispatch edilecek ve reducer içerisindeki displayFavorites state'i değişecek.
  const toggleFav = () => {
    ...
    <div className="flex justify-between items-center shadow rounded-md bg-white p-2 pl-3 my-3">
      ...
      <div className="flex items-center gap-2">
        <div className="myButton bg-blue-600 hover:bg-blue-500">
          <span onClick={toggleFav}>Favorileri {displayFavorites ? "gizle" : "göster"}</span>
        </div>
